...
const Galeria = () => {
  const imagenes = [
    ...
    { src: "./img/iris.webp", alt: "Iris", skill: ["DEX", "DANO"] },
    {
      src: "./img/arien.webp",
      alt: "Arien",
      skill: ["DEX", "DANO", "VELOCIDAD"],
    },
    {
      src: "./img/eir.jpg",
      alt: "Eir",
      skill: ["VIT", "DANO", "CURA", "VELOCIDAD"],
    },
    {
      src: "./img/asuka.webp",
      alt: "Asuka",
  ...
  const personajesFiltrados = filtroSkill
    ? imagenes.filter((imagen) => imagen.skill.includes(filtroSkill))
    : imagenes;
      ...
      >
        ...
        <div className="filter-container">
          <div className="filter-buttons">
            ...
            <button onClick={() => setFiltroSkill("")}>TODOS</button>
            <button onClick={() => setFiltroSkill("VIT")}>VIT</button>
            <button onClick={() => setFiltroSkill("INT")}>INT</button>
            <button onClick={() => setFiltroSkill("DEX")}>INT</button>
            

            <p>Filtrar por Habilidad:</p>
            <button onClick={() => setFiltroSkill("")}>TODOS</button>
            <button onClick={() => setFiltroSkill("DANO")}>DANO</button>
            <button onClick={() => setFiltroSkill("VELOCIDAD")}>
              VELOCIDAD
            </button>
            <button onClick={() => setFiltroSkill("CURA")}>CURA</button>
